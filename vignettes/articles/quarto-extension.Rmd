...
Used *after* an `{{< appendix >}}` call instead, they nest that
appendix's own designator in too ("Figure C.3.1"), so a figure numbered
mid-appendix never reads as though it belongs to the main body's own
third section. `scoped_crossref` resolves any of these six shortcodes'
bookmarks. See the extension's own README for the full shortcode list.
