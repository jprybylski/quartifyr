...
#' "default.yaml", package = "quartifyr"), ...)` (issue #27) that also
#' returns the copy's parsed content as an R list, ready to edit in place
#' and hand to [styling_save_overrides()].
#'
